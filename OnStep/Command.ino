...
#ifdef HAL_SERIAL_B_ENABLED//串口B
cb cmdB;
#endif
#ifdef HAL_SERIAL_C_ENABLED//串口C
cb cmdC;
#endif
#if ST4_HAND_CONTROL == ON//ST4手控
cb cmdST4;
#endif
char _replyX[50]=""; cb cmdX;  // virtual command channel for internal use//虚拟命令通道
...
#endif
    else if (cmdX.ready()) { strcpy(command,cmdX.getCmd()); strcpy(parameter,cmdX.getParameter()); cmdX.flush(); process_command=COMMAND_SERIAL_X; }//虚拟命令通道
    else return;//返回
