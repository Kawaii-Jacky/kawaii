...
#define SLEW_RAPID_STOP_DIST          1.0 //    2.0, n, (degrees.) Approx. distance required to stop when a slew              Adjust
...
#define AXIS1_STEPS_PER_DEGREE  28444.44444444445 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
#define AXIS1_STEPS_PER_WORMROT     76800 //  12800, n. Number of steps per worm rotation (PEC Eq mode only:)                <-Req'd
...
#define AXIS2_STEPS_PER_DEGREE  24888.11111111111 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
