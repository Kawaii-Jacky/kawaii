...
void buck_Enable(){ buckEnable = 1; digitalWrite(buck_EN,HIGH); if (LED < 40) digitalWrite(LED,HIGH); }
void buck_Disable(){ buckEnable = 0; digitalWrite(buck_EN,LOW); if (LED < 40) digitalWrite(LED,LOW); PWM = 0; ledcWrite(pwmChannel,0); resetMPPT(); }
